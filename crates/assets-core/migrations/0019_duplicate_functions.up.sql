-- Migration to add duplicate transaction management functions

-- Function to hide duplicate transaction and update references
CREATE OR REPLACE FUNCTION fn_hide_duplicate_transaction(
...
CREATE OR REPLACE FUNCTION fn_unhide_duplicate_transaction(
